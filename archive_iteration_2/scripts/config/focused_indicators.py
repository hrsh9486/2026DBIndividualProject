    ...
    for bundle in (
        FocusedBundleSpec(
            ...
            series=(
                ...
                _series("gst_growth_gap", "GST revenue growth minus nominal GDP growth", "percentage_points", "annual", "GST Portal / Ministry of Finance + RBI/NSO", "Fiscal-year gross GST revenue (CGST, SGST, IGST and cess); fiscal-year nominal GDP", "Annual gross GST-revenue growth less matching fiscal-year nominal-GDP growth.", "gross_gst_revenue_yoy_pct - nominal_gdp_yoy_pct", "Tax-rate, enforcement, refunds, imports and collection timing also affect gross GST receipts.", derived=True),
            ),
        ),
        FocusedBundleSpec(
